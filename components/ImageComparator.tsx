...
const ImageComparator: React.FC<ImageComparatorProps> = ({ beforeImageUrl, afterImageUrl }) => {
  ...
  return (
    <div 
      ref={containerRef} 
      className={`relative w-full max-w-full aspect-square overflow-hidden rounded-lg select-none shadow-2xl cursor-ew-resize transition-all duration-200 ${isDragging ? 'ring-4 ring-sky-500/50 scale-[1.02]' : 'ring-0 scale-100'}`}
